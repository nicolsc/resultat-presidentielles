   ...
   echo "define([], function(){ return({" > ../frontend/data/2012/2/departments/all.js
...
do
   ...
   echo "'0$i'": >> ../frontend/data/2012/2/departments/all.js
   ...
   curl http://www.francetv.fr/resultats/resultats/2012/presidential/2/department/0$i.json >> ../frontend/data/2012/2/departments/all.js
   ...
   echo ', ' >> ../frontend/data/2012/2/departments/all.js
...
do
   ...
   echo "'$i'": >> ../frontend/data/2012/2/departments/all.js
   ...
   curl http://www.francetv.fr/resultats/resultats/2012/presidential/1/department/$i.json >> ../frontend/data/2012/2/departments/all.js
...
echo "'2A'": >> ../frontend/data/2012/2/departments/all.js
...
curl http://www.francetv.fr/resultats/resultats/2012/presidential/2/department/2A.json >> ../frontend/data/2012/2/departments/all.js
...
echo "'2B'": >> ../frontend/data/2012/2/departments/all.js
...
curl http://www.francetv.fr/resultats/resultats/2012/presidential/2/department/2B.json >> ../frontend/data/2012/2/departments/all.js
...
do
   ...
   curl http://www.francetv.fr/resultats/resultats/2007/presidential/2/department/$i.json >> ../frontend/data/2007/2/departments/all.js
   curl http://www.francetv.fr/resultats/resultats/2012/presidential/1/department/$i.json >> ../frontend/data/2012/1/departments/all.js
   curl http://www.francetv.fr/resultats/resultats/2012/presidential/2/department/$i.json >> ../frontend/data/2012/2/departments/all.js



done

#add 978=mayotte, 2012 only
echo ', ' >> ../frontend/data/2012/1/departments/all.js
echo ', ' >> ../frontend/data/2012/2/departments/all.js

echo "'978'": >> ../frontend/data/2012/1/departments/all.js
echo "'978'": >> ../frontend/data/2012/2/departments/all.js

curl http://www.francetv.fr/resultats/resultats/2012/presidential/1/department/978.json >> ../frontend/data/2012/1/departments/all.js
curl http://www.francetv.fr/resultats/resultats/2012/presidential/2/department/978.json >> ../frontend/data/2012/2/departments/all.js
...
echo "define([], function(){return(" > ../frontend/data/2012/2/national.js
...
curl http://www.francetv.fr/resultats/resultats/2012/presidential/2/national/france.json >> ../frontend/data/2012/2/national.js
...
echo ")});" >> ../frontend/data/2012/2/national.js